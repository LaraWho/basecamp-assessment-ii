...
var myFriends = ["Amy", "Rich", "Danny", "Katie"];
...
// #8 Below is a array, myNumbers. Create a function called 'evensOnly' that
//returns the 'evensArray' of only even numbers
//DON'T TOUCH THE CODE BELOW
...
//and return the result into a new array called 'indexes' with just their indexes.
//Be sure to invoke indexFinder.
let randomNumbers = [1, 3453, 34, 456, 32, 3, 2, 0];
var indexes = [];
function indexFinder() {
  randomNumbers.forEach(function(val, i) {
  indexes.push(i);
});
  return indexes;
}
